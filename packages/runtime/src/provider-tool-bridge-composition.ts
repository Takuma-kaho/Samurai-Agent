...
const providerToolBridgeDeclarations: readonly ProviderToolBridgeDeclaration[] = [
  ...
  { name: "samurai.collection.schema.save", provider_tool_name: "mcp__samurai__collection_schema_save", title: "Save Samurai Collection Schema", description: "Save a validated CollectionSchema for a personal Workspace data app. Supported views include collection_table, collection_gallery, calendar_view, and collection_kanban." },
