...
const workspaceMemberRemove = defineCommand<WorkspaceMemberRemovePorts>()({
  id: "workspace.member.remove", version: "1.1", availability: "active", title: "Remove Workspace member", description: "Mark a Workspace membership as removed.",
  ...
  provenance: [{ source: "samurai", commit_sha: "core-06", reference_file: "ARCHITECTURE.md", decision: "adapted", reason: "Removal preserves the membership history." }], input: Input, output: Output,
