...
const workspaceMemberAdd = defineCommand<WorkspaceMemberAddPorts>()({
  id: "workspace.member.add", version: "1.0", availability: "active", title: "Add Workspace member", description: "Add a human Workspace member without granting Room access.",
  ...
  provenance: [{ source: "samurai", commit_sha: "core-06", reference_file: "SAMURAI_AGENT_MANUAL.md", decision: "adapted", reason: "Workspace membership never implies Room visibility." }], input: Input, output: Output,
