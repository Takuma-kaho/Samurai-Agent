...
const workspaceMemberList = defineQuery<WorkspaceMemberListPorts>()({
  id: "workspace.member.list", version: "1.1", availability: "active", title: "List Workspace members", description: "List current Workspace members.",
  ...
  provenance: [{ source: "samurai", commit_sha: "core-06", reference_file: "ARCHITECTURE.md", decision: "adapted", reason: "Membership administration is distinct from Room access." }], input: Input, output: Output,
