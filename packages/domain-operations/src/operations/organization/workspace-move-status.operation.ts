...
const workspaceOrganizationMoveStatus = defineQuery<WorkspaceOrganizationMoveStatusPorts>()({
  id: "workspace.organization.move.status", version: "1.0", availability: "active", title: "Get Workspace Organization move status", description: "Read the durable status of a Workspace Organization move operation.",
  ...
  provenance: [{ source: "samurai", commit_sha: "phase-2-organization", reference_file: "docs/designs/organization.md", decision: "adopted", reason: "Move status is a query over the operation ledger and contains no Room content." }],
