...
const workspaceOrganizationMoveCommit = defineCommand<WorkspaceOrganizationMoveCommitPorts>()({
  id: "workspace.organization.move.commit", version: "1.0", availability: "active", title: "Move Workspace between Organizations", description: "Commit a previously previewed Workspace move in one transaction.",
  ...
  provenance: [{ source: "samurai", commit_sha: "phase-2-organization", reference_file: "docs/designs/organization.md", decision: "adopted", reason: "The operation ledger and source/target/workspace lock order make ownership, Guest completion, and Event insertion atomic." }],
