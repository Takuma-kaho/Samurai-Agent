...
const roomMemberAdd = defineCommand<RoomMemberAddPorts>()({
  id: "room.member.add", version: "1.1", availability: "active", title: "Add Room participant", description: "Add a human participant to one Room.",
  ...
  provenance: [{ source: "samurai", commit_sha: "core-06", reference_file: "ARCHITECTURE.md", decision: "adapted", reason: "Room participation is separate from Workspace membership." }], input: Input, output: Output,
