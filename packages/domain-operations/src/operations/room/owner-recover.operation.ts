...
const roomOwnerRecover = defineCommand<RoomOwnerRecoverPorts>()({
  id: "room.owner.recover", version: "1.1", availability: "active", title: "Recover ownerless Room", description: "Assign one Owner only when a Room has no active Owner.",
  ...
  provenance: [{ source: "samurai", commit_sha: "core-06", reference_file: "ARCHITECTURE.md", decision: "adapted", reason: "Only the Workspace Owner can recover an ownerless Room." }], input: Input, output: Output,
