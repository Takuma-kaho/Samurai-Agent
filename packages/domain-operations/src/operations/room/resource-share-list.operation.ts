...
const roomResourceShareList = defineQuery<RoomResourceShareListPorts>()({
  id: "room.resource.share.list", version: "2.1", availability: "active", title: "List Room resource shares", description: "List current target Rooms for one explicitly shared resource.",
  ...
  provenance: [{ source: "samurai", commit_sha: "core-06", reference_file: "ARCHITECTURE.md", decision: "adapted", reason: "Share status is visible only through a participating Room." }], input: Input, output: Output,
