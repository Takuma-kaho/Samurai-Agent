...
const agentWorkspacePermissionSet = defineCommand<AgentWorkspacePermissionSetPorts>()({
  id: "agent.workspace_permission.set", version: "1.1", availability: "active", title: "Set Agent Room creation permission", description: "Grant or revoke the explicit Agent Room creation permission.",
  ...
  provenance: [{ source: "samurai", commit_sha: "core-06", reference_file: "ARCHITECTURE.md", decision: "adapted", reason: "Agents can create Rooms only through an explicit permission." }], input: Input, output: Output,
