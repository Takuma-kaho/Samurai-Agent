...
const owners: readonly WorkspaceResourceOwner[] = [
  ...
  },
  {
    ...
    directories: [],
    backup_roots: [],
    sqlite_tables: ["automation_jobs", "automation_runs", "external_app_connections", "external_app_connection_rooms", "external_app_connection_ingress_classes"]
  },
  {
    owner: "external_integration",
    directories: [],
    backup_roots: [],
    sqlite_tables: ["external_integration_records", "external_capture_quota_usage"]
  },
  {
    owner: "gateway",
    directories: [],
...
const legacyBoundaries: readonly WorkspaceResourceBoundary[] = [
  ...
  { resource: "gateway_automation", source_of_truth: "sqlite", file_roots: [], sqlite_tables: ["automation_jobs", "automation_runs", "external_app_connections", "external_app_connection_rooms", "external_app_connection_ingress_classes", "external_sends", "gateway_pairings", "gateway_pairing_policies", "gateway_routing_policies", "gateway_inbound_messages", "gateway_deliveries", "gateway_boundary_policies", "gateway_mcp_configs", "gateway_concurrency_locks", "gateway_sandbox_instances", "gateway_sandbox_workspace_syncs"], sqlite_role: "queue", note: "Gateway and scheduler state are operational queues and control-plane records, not workspace prose." },
  { resource: "external_integration", source_of_truth: "sqlite", file_roots: [], sqlite_tables: ["external_integration_records", "external_capture_quota_usage"], sqlite_role: "metadata", note: "OAuth, Room binding, external Session, approval, capture metadata, Connector capability, Activity dedupe records, and atomic Capture quota usage remain operational integration state." },
