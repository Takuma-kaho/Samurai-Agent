...
export type { ExternalIntegrationRecordsTable, ExternalCaptureQuotaUsageTable } from "../rows/external-integration-rows";
...
export type { SettingsTable, RoomContextMetadataTable, PluginStatesTable, ResourceTranslationsTable } from "../rows/workspace-metadata-rows";
...
import type { ExternalIntegrationRecordsTable, ExternalCaptureQuotaUsageTable } from "../rows/external-integration-rows";
import type { ExternalSendsTable, GatewayPairingsTable, GatewayPairingPoliciesTable, GatewayRoutingPoliciesTable, GatewayInboundMessagesTable, GatewayDeliveriesTable, GatewayBoundaryPoliciesTable, GatewayMcpConfigsTable, GatewayConcurrencyLocksTable, GatewaySandboxInstancesTable, GatewaySandboxWorkspaceSyncsTable } from "../rows/gateway-rows";
import type { SettingsTable, RoomContextMetadataTable, PluginStatesTable, ResourceTranslationsTable } from "../rows/workspace-metadata-rows";
...
export interface WorkspaceDb {
  ...
  external_integration_records: ExternalIntegrationRecordsTable;
  external_capture_quota_usage: ExternalCaptureQuotaUsageTable;
  ...
  room_context_metadata: RoomContextMetadataTable;
