...
export interface SkillIndexTable { id: string; state: string; title: string; description: string; tags_json: JsonColumn; required_capabilities_json: JsonColumn; usage_scope_kind: string | null; usage_scope_ref_id: string | null; file_path: string; frontmatter_json: JsonColumn; resource_version: number; created_at: string; updated_at: string; }
