...
const sourceFiles = ["packages/core-schemas/src/index.ts", "packages/runtime/src/attachments/ingestion.ts", "scripts/fixtures/attachment-ingestion.ts", "scripts/verify-attachment-ingestion.mjs", "scripts/lib/core-evidence.mjs", "scripts/lib/verifier-assertions.mjs"];
try {
