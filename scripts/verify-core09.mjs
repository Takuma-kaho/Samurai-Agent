...
function verifyChangedScope() {
  ...
  const allowed = [
    ...
    "scripts/verify-core-additions-regression.mjs",
    ...
    "scripts/fixtures/domain-operation-handler-expectations.ts",
    "scripts/fixtures/domain-operation-handler-expectations-shard-b.ts",
    "scripts/fixtures/domain-operation-handler-matrix.ts",
    "scripts/fixtures/domain-operation-handler-matrix-aggregate.ts",
    "scripts/fixtures/domain-operation-handler-matrix-shard-b.ts",
    "scripts/fixtures/domain-query-purity.ts",
    "scripts/check-domain-commands.mjs",
    "scripts/verify-domain-command-schema-matrix-self-test.mjs",
