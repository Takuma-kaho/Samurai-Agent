...
const sourceFiles = ["packages/workspace-store/src/index.ts", "scripts/fixtures/workspace-restore-atomicity.ts", "scripts/verify-workspace-restore-atomicity.mjs", "scripts/lib/core-evidence.mjs"];
try {
