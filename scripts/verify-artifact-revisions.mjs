...
const sourceFiles = ["packages/core-schemas/src/index.ts", "packages/action-catalog/src/index.ts", "packages/workspace-store/src/index.ts", "packages/runtime/src/index.ts", "scripts/fixtures/artifact-revisions.ts", "scripts/verify-artifact-revisions.mjs", "scripts/lib/core-evidence.mjs"];
try {
