...
export const aHandlerExpectations = {
  "artifact.create": {
    requiredBranches: ["session:existing", "session:create", "kind:graph", "kind:non_graph"],
    cases: artifactKinds.map((kind, index) => {
      ...
      return {
        ...
        branches: [kind === "graph" ? "kind:graph" : "kind:non_graph", noSession ? "session:create" : "session:existing"],
        ...(noSession ? { context: { sessionId: undefined, envelopeId: "envelope_create" } } : {}),
        calls: [
          ...(kind === "graph" ? [call("validateGraphArtifactContent", kind === "graph" ? JSON.stringify(graphDocument) : `Fixture ${kind}`)] : []),
          ...(noSession ? [call("createArtifactSession", { title: `Fixture ${kind}`, output_locale: outputLocale })] : [call("getArtifactSession", "session_fixture")]),
          call("artifactContract", "artifact.create"),
          call("createArtifactEnvelope", session, kind === "graph" ? JSON.stringify(graphDocument) : `Fixture ${kind}`, inputLocale, outputLocale, { fixture: kind }, noSession ? "envelope_create" : undefined),
          call("runArtifactMutation", mutation("artifact.create", ["Create a local workspace artifact draft."])),
  ...
  "artifact.export_pdf": {
    ...
    cases: [{
      ...
      calls: [
        ...
        call("ensureArtifactSession"), call("createArtifactEnvelope", session, "Export PDF: Fixture artifact"),
        call("runArtifactMutation", mutation("artifact.export_pdf", ["Create a PDF Artifact from the selected source Artifact."], { targetResourceRefs: [artifactRef] })),
        call("createArtifactDraft", { operation, title: "Fixture artifact.pdf", content: { bytes: new Uint8Array([0x25, 0x50, 0x44, 0x46, 0x2d, 0x31, 0x2e, 0x37]), mime_type: "application/pdf", extension: "pdf", preview: "Fixture artifact" }, kind: "pdf", locale: "en", sourceLocales: ["en"], createdBy: "pdf_export_adapter", metadata: { source_artifact_id: "artifact_fixture", source_revision_id: "revision_fixture", export_adapter_id: "fixture_adapter" } }),
  ...
  "artifact.repair": {
    ...
    cases: [{
      ...
      calls: [call("artifactContract", "artifact.repair"), call("getArtifact", "artifact_fixture"), call("ensureArtifactSession"), call("createArtifactEnvelope", session, "Repair artifact source: Fixture artifact"), call("runArtifactMutation", mutation("artifact.repair", ["Restore a missing Artifact revision file from its verified content blob."], { targetResourceRefs: [artifactRef] })), call("repairArtifactRevisionSource", "artifact_fixture")]
    }]
  },
  "artifact.restore_revision": {
    ...
    cases: [{
      id: "all-fields",
      input: { artifact_id: "artifact_fixture", revision_id: "revision_fixture", base_revision_id: "base_fixture", change_summary: "Restore fixture revision" },
      branches: ["revision:explicit-options"],
      calls: [
        call("artifactContract", "artifact.restore_revision"), call("getArtifact", "artifact_fixture"), call("getArtifactRevision", "revision_fixture"), call("readArtifactRevisionContent", "revision_fixture"), call("ensureArtifactSession"), call("createArtifactEnvelope", session, "Restore artifact revision: Fixture artifact"),
        call("runArtifactMutation", mutation("artifact.restore_revision", ["Create a new current Artifact revision from an earlier revision."], { targetResourceRefs: [artifactRef, revisionRef] })),
        call("createArtifactRevision", { artifactId: "artifact_fixture", content: new Uint8Array([1, 2, 3]), baseRevisionId: "base_fixture", editorSource: "restore", changeSummary: "Restore fixture revision", provenance: { restored_from_revision_id: "revision_fixture" } }),
        call("createArtifactRollback", operation, [artifactRef, revisionRef], { artifact }, { artifact })
      ]
    }]
  },
  "artifact.revise": {
    requiredBranches: ["session:existing", ...editorSources.map((value) => `editor_source:${value}`)],
    cases: editorSources.map((editor_source, index) => ({
      id: `editor-${editor_source}`,
      input: { artifact_id: "artifact_fixture", content: `Revised ${editor_source}`, base_revision_id: "base_fixture", change_summary: `Update ${editor_source}`, editor_source, extension: "md", provenance: { editor_source } },
      branches: ["session:existing", `editor_source:${editor_source}`],
      calls: [
        call("getArtifact", "artifact_fixture"), call("getArtifactSession", "session_fixture"), call("artifactContract", "artifact.revise"), call("createArtifactEnvelope", session, "Revise artifact: Fixture artifact"),
        call("runArtifactMutation", mutation("artifact.revise", ["Create an immutable Artifact revision and update its current pointer."], { targetResourceRefs: [artifactRef] })),
        call("createArtifactRevision", { artifactId: "artifact_fixture", content: `Revised ${editor_source}`, producerRunId: "run_fixture", extension: "md", baseRevisionId: "base_fixture", editorSource: editor_source, changeSummary: `Update ${editor_source}`, provenance: { editor_source } }),
        call("createArtifactRollback", operation, [artifactRef, revisionRef], { artifact }, { artifact })
      ]
    }))
  },
  ...
  "collection.patch.apply": {
    ...
    cases: [{ id: "all-fields", input: { collection_id: "collection_fixture", record_id: "record_fixture", changes: { status: "done" }, expected_version: 2, patch_id: "patch_fixture" }, branches: ["patch:explicit-id-and-version"], calls: [call("ensureCollectionMutationSession"), call("createCollectionMutationEnvelope", "Apply collection patch: collection_fixture/record_fixture"), call("runCollectionMutation", mutation("collection.patch.apply", ["Apply a collection patch to an existing local record."])), call("applyCollectionRecordPatch", { collectionId: "collection_fixture", recordId: "record_fixture", patch: { id: "patch_fixture", record_id: "record_fixture", changes: { status: "done" }, expected_version: 2, source_operation_id: "operation_fixture", created_at: "$generated:time" } }), call("collectionRecordRef", collectionRecord), call("createCollectionRollback", operation, [collectionRecordRef], { record: collectionRecord }, { record: collectionRecord }), call("queueCollectionTrigger", { collectionId: "collection_fixture", recordId: "record_fixture", event: "record.patched" })] }]
  },
  "collection.record.create": {
    requiredBranches: ["record:explicit-id-and-refs"],
    cases: [{ id: "all-fields", input: { collection_id: "collection_fixture", record_id: "record_fixture", data: { title: "Fixture" }, resource_refs: [artifactRef] }, branches: ["record:explicit-id-and-refs"], calls: [call("ensureCollectionMutationSession"), call("createCollectionMutationEnvelope", "Create collection record: collection_fixture/record_fixture"), call("runCollectionMutation", mutation("collection.record.create", ["Create a collection record file and SQLite index row."])), call("saveCollectionRecord", { id: "record_fixture", collection_id: "collection_fixture", version: 1, data: { title: "Fixture" }, resource_refs: [artifactRef], created_at: "$generated:time", updated_at: "$generated:time" }), call("collectionRecordRef", collectionRecord), call("createCollectionRollback", operation, [collectionRecordRef], {}, { collection_id: "collection_fixture", record_id: "record_fixture" }), call("queueCollectionTrigger", { collectionId: "collection_fixture", recordId: "record_fixture", event: "record.created" })] }]
  },
  "collection.record.delete": {
    requiredBranches: ["view_id:explicit", "view_id:omitted"],
    cases: [
      { id: "explicit-view", input: { collection_id: "collection_fixture", record_id: "record_fixture", view_id: "view_fixture" }, branches: ["view_id:explicit"], calls: [call("getCollectionSchemaForMutation", "collection_fixture"), call("collectionDeleteAllowed", collectionSchema, "view_fixture"), call("getCollectionRecord", "collection_fixture", "record_fixture"), call("ensureCollectionMutationSession"), call("createCollectionMutationEnvelope", "Delete collection record: collection_fixture/record_fixture"), call("runCollectionMutation", mutation("collection.record.delete", ["Delete a collection record file and SQLite index row."])), call("deleteCollectionRecord", "collection_fixture", "record_fixture"), call("collectionRecordRef", collectionRecord), call("createCollectionRollback", operation, [collectionRecordRef], { record: collectionRecord }, {})] },
  ...
  "collection.reindex": {
    ...
    cases: [{ id: "empty-input", input: {}, branches: ["reindex:all"], calls: [call("collectionMutationContract", "collection.reindex"), call("ensureCollectionMutationSession"), call("createCollectionMutationEnvelope", "Reindex collections"), call("runCollectionMutation", mutation("collection.reindex", ["Refresh Collection SQLite indexes from schema and record files."])), call("reindexCollectionStore")] }]
  },
  "collection.schema.save": {
    requiredBranches: ["schema:create", "schema:update"],
    cases: [
      { id: "create-all-fields", input: { id: "collection_fixture", version: "1", labels: {}, descriptions: {}, fields: [], refs: [], embeds: [], derived_fields: [], triggers: [], actions: [], views: [], permissions: {} }, branches: ["schema:create"], calls: [call("getCollectionSchemaForMutation", "collection_fixture"), call("collectionMutationContract", "collection.schema.save"), call("ensureCollectionMutationSession"), call("createCollectionMutationEnvelope", "Save collection schema: collection_fixture"), call("runCollectionMutation", mutation("collection.schema.save", ["Create a Collection schema file, renderer view definitions, and SQLite index row."], { targetResourceRefs: [] })), call("saveCollectionSchema", { id: "collection_fixture", version: "1", labels: {}, descriptions: {}, fields: [], refs: [], embeds: [], derived_fields: [], triggers: [], actions: [], views: [], permissions: {} }), call("collectionSchemaRef", collectionSchema), call("createCollectionRollback", operation, [collectionSchemaRef], {}, { collection_schema: collectionSchema })] },
      { id: "update-all-fields", input: { id: "collection_fixture", version: "1", labels: {}, descriptions: {}, fields: [], refs: [], embeds: [], derived_fields: [], triggers: [], actions: [], views: [], permissions: {} }, branches: ["schema:update"], calls: [call("getCollectionSchemaForMutation", "collection_fixture"), call("collectionMutationContract", "collection.schema.save"), call("ensureCollectionMutationSession"), call("createCollectionMutationEnvelope", "Save collection schema: collection_fixture"), call("collectionSchemaRef", collectionSchema), call("runCollectionMutation", mutation("collection.schema.save", ["Create a Collection schema file, renderer view definitions, and SQLite index row."], { targetResourceRefs: [collectionSchemaRef] })), call("updateCollectionSchema", { id: "collection_fixture", version: "1", labels: {}, descriptions: {}, fields: [], refs: [], embeds: [], derived_fields: [], triggers: [], actions: [], views: [], permissions: {} }), call("collectionSchemaRef", collectionSchema), call("createCollectionRollback", operation, [collectionSchemaRef], { collection_schema: collectionSchema }, { collection_schema: collectionSchema })] }
    ]
  },
  ...
  "generated_surface.create": {
    ...
    cases: [
      { id: "direct-message", input: { bundle: surfaceBundle, request: surfaceRequest("message", "built_in_surface") }, branches: ["bundle:direct", "lifetime:message"], nestedBranches: [{ path: ["bundle"], branch: 0, label: "direct" }], calls: [call("createGeneratedSurfaceRequestId"), call("generatedSurfaceNow"), call("generatedSurfaceFingerprint", "Show fixture"), call("buildGeneratedSurfaceRevision", { request: persistedSurfaceRequest("message", "built_in_surface"), bundle: surfaceBundle, producerRunId: "run_fixture", promptFingerprint: "surface_hash" }), call("saveGeneratedSurfaceRevision", { definition: surface, revision: surfaceRevision, html: "<main>fixture</main>", css: "main{}", script: "", assets: surfaceBundle.assets })] },
      { id: "custom-session", input: { bundle: { custom_view: surfaceBundle }, request: surfaceRequest("session", "artifact") }, branches: ["bundle:custom_view", "lifetime:session"], nestedBranches: [{ path: ["bundle"], branch: 1, label: "custom_view" }], calls: [call("createGeneratedSurfaceRequestId"), call("generatedSurfaceNow"), call("generatedSurfaceFingerprint", "Show fixture"), call("buildGeneratedSurfaceRevision", { request: persistedSurfaceRequest("session", "artifact"), bundle: surfaceBundle, producerRunId: "run_fixture", promptFingerprint: "surface_hash" }), call("saveGeneratedSurfaceRevision", { definition: surface, revision: surfaceRevision, html: "<main>fixture</main>", css: "main{}", script: "", assets: surfaceBundle.assets })] },
      { id: "direct-pinned", input: { bundle: surfaceBundle, request: surfaceRequest("pinned", "text") }, branches: ["bundle:direct", "lifetime:pinned"], nestedBranches: [{ path: ["bundle"], branch: 0, label: "direct" }], calls: [call("createGeneratedSurfaceRequestId"), call("generatedSurfaceNow"), call("generatedSurfaceFingerprint", "Show fixture"), call("buildGeneratedSurfaceRevision", { request: persistedSurfaceRequest("pinned", "text"), bundle: surfaceBundle, producerRunId: "run_fixture", promptFingerprint: "surface_hash" }), call("saveGeneratedSurfaceRevision", { definition: surface, revision: surfaceRevision, html: "<main>fixture</main>", css: "main{}", script: "", assets: surfaceBundle.assets })] }
    ]
  },
      ...
      return {
        ...
        calls: [
          ...
          call("saveGeneratedSurfaceInteraction", {
            ...
            kind,
            session_id: "session_fixture",
            message_id: index === 0 ? "message_fixture" : undefined,
            surface_id: "surface_fixture",
  ...
  "generated_surface.revise": {
    requiredBranches: ["bundle:direct", "bundle:custom_view", "lifetime:message", "lifetime:session", "lifetime:pinned"],
    cases: [
      { id: "direct-message", input: { surface_id: "surface_fixture", bundle: surfaceBundle, request: surfaceRequest("message", "built_in_surface") }, branches: ["bundle:direct", "lifetime:message"], nestedBranches: [{ path: ["bundle"], branch: 0, label: "direct" }], calls: [call("getGeneratedSurface", "surface_fixture"), call("createGeneratedSurfaceRequestId"), call("generatedSurfaceNow"), call("generatedSurfaceFingerprint", "Show fixture"), call("buildGeneratedSurfaceRevision", { request: persistedSurfaceRequest("message", "built_in_surface"), bundle: surfaceBundle, existing: surface, producerRunId: "run_fixture", promptFingerprint: "surface_hash" }), call("saveGeneratedSurfaceRevision", { definition: surface, revision: surfaceRevision, html: "<main>fixture</main>", css: "main{}", script: "", assets: surfaceBundle.assets })] },
      { id: "custom-session", input: { surface_id: "surface_fixture", bundle: { custom_view: surfaceBundle }, request: surfaceRequest("session", "artifact") }, branches: ["bundle:custom_view", "lifetime:session"], nestedBranches: [{ path: ["bundle"], branch: 1, label: "custom_view" }], calls: [call("getGeneratedSurface", "surface_fixture"), call("createGeneratedSurfaceRequestId"), call("generatedSurfaceNow"), call("generatedSurfaceFingerprint", "Show fixture"), call("buildGeneratedSurfaceRevision", { request: persistedSurfaceRequest("session", "artifact"), bundle: surfaceBundle, existing: surface, producerRunId: "run_fixture", promptFingerprint: "surface_hash" }), call("saveGeneratedSurfaceRevision", { definition: surface, revision: surfaceRevision, html: "<main>fixture</main>", css: "main{}", script: "", assets: surfaceBundle.assets })] },
      { id: "direct-pinned", input: { surface_id: "surface_fixture", bundle: surfaceBundle, request: surfaceRequest("pinned", "text") }, branches: ["bundle:direct", "lifetime:pinned"], nestedBranches: [{ path: ["bundle"], branch: 0, label: "direct" }], calls: [call("getGeneratedSurface", "surface_fixture"), call("createGeneratedSurfaceRequestId"), call("generatedSurfaceNow"), call("generatedSurfaceFingerprint", "Show fixture"), call("buildGeneratedSurfaceRevision", { request: persistedSurfaceRequest("pinned", "text"), bundle: surfaceBundle, existing: surface, producerRunId: "run_fixture", promptFingerprint: "surface_hash" }), call("saveGeneratedSurfaceRevision", { definition: surface, revision: surfaceRevision, html: "<main>fixture</main>", css: "main{}", script: "", assets: surfaceBundle.assets })] }
    ]
  },
  ...
  "graph.create": {
    ...
    cases: localeValues.map((input_locale, index) => {
      ...
      const noSession = index === 0;
      return { id: `locale-${input_locale}`, input: { content: JSON.stringify(graphDocument), title: `Graph ${input_locale}`, input_locale, output_locale, ui_locale, metadata: { locale: input_locale } }, branches: [noSession ? "session:create" : "session:existing"], ...(noSession ? { context: { sessionId: undefined, envelopeId: "envelope_graph" } } : {}), calls: [call("validateGraphArtifactContent", JSON.stringify(graphDocument)), ...(noSession ? [call("createArtifactSession", { title: `Graph ${input_locale}`, ui_locale, output_locale })] : [call("getArtifactSession", "session_fixture")]), call("artifactContract", "graph.create"), call("createArtifactEnvelope", session, JSON.stringify(graphDocument), input_locale, output_locale, { locale: input_locale }, noSession ? "envelope_graph" : undefined), call("runArtifactMutation", mutation("graph.create", ["Create a validated graph Artifact in the Workspace."])), call("createArtifactDraft", { operation, title: `Graph ${input_locale}`, content: JSON.stringify(graphDocument), kind: "graph", locale: output_locale, sourceLocales: [input_locale], createdBy: "handler-matrix-actor" }), call("createArtifactRollback", operation, [artifactRef], {}, { artifact_id: "artifact_fixture" })] };
    })
  },
  "graph.patch": {
    requiredBranches: editorSources.map((value) => `editor_source:${value}`),
    cases: editorSources.map((editor_source) => ({ id: `editor-${editor_source}`, input: { artifact_id: "graph_fixture", base_revision_id: "base_fixture", change_summary: `Patch ${editor_source}`, delete_edge_ids: [], delete_node_ids: [], document: graphDocument, edges: [], editor_source, nodes: [], provenance: { editor_source } }, branches: [`editor_source:${editor_source}`], calls: [call("getArtifact", "graph_fixture"), call("readArtifactContent", "graph_fixture"), call("artifactContract", "graph.patch"), call("ensureArtifactSession"), call("createArtifactEnvelope", session, "Edit graph: Fixture graph"), call("runArtifactMutation", mutation("graph.patch", ["Create a new graph Artifact revision from validated node and edge edits."], { targetResourceRefs: [graphArtifactRef] })), call("createArtifactRevision", { artifactId: "graph_fixture", content: "{\n  \"version\": \"1\",\n  \"nodes\": [],\n  \"edges\": []\n}\n", extension: "json", baseRevisionId: "base_fixture", editorSource: editor_source, changeSummary: `Patch ${editor_source}`, provenance: { editor_source } }), call("createArtifactRollback", operation, [graphArtifactRef, revisionRef], { artifact: graphArtifact }, { artifact: graphArtifact })] }))
  },
  "rollback.restore": {
    requiredBranches: ["snapshot:written", "snapshot:deleted"],
    cases: [
      { id: "written", input: { rollback_point_id: "rollback_written" }, branches: ["snapshot:written"], calls: [call("getRollbackPoint", "rollback_written"), call("currentTimeMillis"), call("resolveRollbackPath", "workspace/fixture.txt"), call("ensureRollbackSession"), call("createRollbackEnvelope", "rollback.restore: rollback_written"), call("rollbackFileRef", "workspace/fixture.txt"), call("runRollbackMutation", mutation("rollback.restore", ["Restore rollback point rollback_written for workspace/fixture.txt."], { targetResourceRefs: [fileRef] })), call("readRollbackFile", "/tmp/handler-matrix/workspace/fixture.txt"), call("ensureRollbackParent", "/tmp/handler-matrix/workspace/fixture.txt"), call("writeRollbackFile", "/tmp/handler-matrix/workspace/fixture.txt", "fixture"), call("createRestoreRollback", operation, [fileRef], { path: "workspace/fixture.txt", content: "before fixture" }, { path: "workspace/fixture.txt", content: "fixture" })] },
      { id: "deleted", input: { rollback_point_id: "rollback_deleted" }, branches: ["snapshot:deleted"], calls: [call("getRollbackPoint", "rollback_deleted"), call("currentTimeMillis"), call("resolveRollbackPath", "workspace/fixture.txt"), call("ensureRollbackSession"), call("createRollbackEnvelope", "rollback.restore: rollback_deleted"), call("rollbackFileRef", "workspace/fixture.txt"), call("runRollbackMutation", mutation("rollback.restore", ["Restore rollback point rollback_deleted for workspace/fixture.txt."], { targetResourceRefs: [fileRef] })), call("readRollbackFile", "/tmp/handler-matrix/workspace/fixture.txt"), call("removeRollbackFile", "/tmp/handler-matrix/workspace/fixture.txt"), call("createRestoreRollback", operation, [fileRef], { path: "workspace/fixture.txt", content: "before fixture" }, { path: "workspace/fixture.txt", content: null })] }
    ]
  },
  ...
  "file.patch": {
    ...
    cases: [
      { id: "managed", input: { path: "workspace/fixture.txt", search: "before", replace: "after" }, branches: ["collection:managed"], calls: [call("resolveFilePath", "workspace/fixture.txt"), call("ensureFileSession"), call("createFileEnvelope", session, "file.patch: workspace/fixture.txt"), call("runFileMutation", mutation("file.patch", ["file.patch workspace/fixture.txt inside the workspace."], { targetResourceRefs: [fileRef] })), call("readFileTextIfExists", "/tmp/handler-matrix/workspace/fixture.txt"), call("ensureFileParent", "/tmp/handler-matrix/workspace/fixture.txt"), call("writeFileText", "/tmp/handler-matrix/workspace/fixture.txt", "after fixture"), call("isManagedCollectionPath", "workspace/fixture.txt"), call("reindexManagedCollections"), call("createFileRollback", operation, [fileRef], { path: "workspace/fixture.txt", content: "before fixture" }, { path: "workspace/fixture.txt", content: "after fixture" })] },
      { id: "unmanaged", input: { path: "notes/fixture.txt", search: "before", replace: "after" }, branches: ["collection:unmanaged"], calls: [call("resolveFilePath", "notes/fixture.txt"), call("ensureFileSession"), call("createFileEnvelope", session, "file.patch: notes/fixture.txt"), call("runFileMutation", mutation("file.patch", ["file.patch notes/fixture.txt inside the workspace."], { targetResourceRefs: [browserFileRef("notes/fixture.txt")] })), call("readFileTextIfExists", "/tmp/handler-matrix/notes/fixture.txt"), call("ensureFileParent", "/tmp/handler-matrix/notes/fixture.txt"), call("writeFileText", "/tmp/handler-matrix/notes/fixture.txt", "after fixture"), call("isManagedCollectionPath", "notes/fixture.txt"), call("createFileRollback", operation, [browserFileRef("notes/fixture.txt")], { path: "notes/fixture.txt", content: "before fixture" }, { path: "notes/fixture.txt", content: "after fixture" })] }
    ]
  },
  "file.write": {
    requiredBranches: ["collection:managed", "collection:unmanaged"],
    cases: [
      { id: "managed", input: { path: "workspace/fixture.txt", content: "written fixture" }, branches: ["collection:managed"], calls: [call("resolveFilePath", "workspace/fixture.txt"), call("ensureFileSession"), call("createFileEnvelope", session, "file.write: workspace/fixture.txt"), call("runFileMutation", mutation("file.write", ["file.write workspace/fixture.txt inside the workspace."], { targetResourceRefs: [fileRef] })), call("readFileTextIfExists", "/tmp/handler-matrix/workspace/fixture.txt"), call("ensureFileParent", "/tmp/handler-matrix/workspace/fixture.txt"), call("writeFileText", "/tmp/handler-matrix/workspace/fixture.txt", "written fixture"), call("isManagedCollectionPath", "workspace/fixture.txt"), call("reindexManagedCollections"), call("createFileRollback", operation, [fileRef], { path: "workspace/fixture.txt", content: "before fixture" }, { path: "workspace/fixture.txt", content: "written fixture" })] },
      { id: "unmanaged", input: { path: "notes/fixture.txt", content: "written fixture" }, branches: ["collection:unmanaged"], calls: [call("resolveFilePath", "notes/fixture.txt"), call("ensureFileSession"), call("createFileEnvelope", session, "file.write: notes/fixture.txt"), call("runFileMutation", mutation("file.write", ["file.write notes/fixture.txt inside the workspace."], { targetResourceRefs: [browserFileRef("notes/fixture.txt")] })), call("readFileTextIfExists", "/tmp/handler-matrix/notes/fixture.txt"), call("ensureFileParent", "/tmp/handler-matrix/notes/fixture.txt"), call("writeFileText", "/tmp/handler-matrix/notes/fixture.txt", "written fixture"), call("isManagedCollectionPath", "notes/fixture.txt"), call("createFileRollback", operation, [browserFileRef("notes/fixture.txt")], { path: "notes/fixture.txt", content: "before fixture" }, { path: "notes/fixture.txt", content: "written fixture" })] }
    ]
  }
