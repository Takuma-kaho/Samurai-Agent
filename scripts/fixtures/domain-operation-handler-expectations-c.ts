...
const roomOnlyContext = { inputSource: "runtime_api", workspaceId: "handler-matrix-c-workspace", actorId: "owner", correlationId: "handler-matrix-c", roomId: "room_fixture", sessionId: undefined, runId: "run_fixture", envelopeId: undefined };
const trustedContextFixture = { inputSource: "runtime_api", workspaceId: "handler-matrix-c-workspace", actorId: "owner", correlationId: "handler-matrix-c", roomId: "room_fixture", sessionId: "session_fixture", runId: "run_fixture", envelopeId: "envelope_fixture" };
