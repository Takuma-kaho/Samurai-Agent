...
- [native-app.md](native-app.md)：Workspace-firstのNative App設計。Roomでの仕事、Agent・人間の権限管理、Knowledge/Skill、検索・設定・確認待ち・自動化、成果物・Surface、React完結と旧Vue整理の境界、Electron、実機確認を扱う。詳細は未実装部分を含む目標設計。
