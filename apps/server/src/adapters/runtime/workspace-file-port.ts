...
/**
 * Application-owned filesystem capability for Runtime composition.
 * Runtime receives this capability and never imports a filesystem driver.
 */
export function createRuntimeWorkspaceFilePort(): WorkspaceFilePort {
  return {
